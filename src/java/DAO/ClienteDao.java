...
public Cliente LoginCliente(String login, String senha, HttpServletRequest request) throws SQLException {
 ...
 public static void AlterarDados(Cliente cliente) throws Exception {
        ...
        statement.setString(2, cliente.getCpfCnpj());
        statement.setString(3, cliente.getRgIe());
        statement.setString(4, cliente.getTelefoneResidencial());
        statement.setString(5, cliente.getCelular());
        statement.setString(6, cliente.getTelefoneRecado());
        statement.setString(7, cliente.getSenha());
        statement.setString(8, cliente.getEmail());
        statement.setInt(9, cliente.getSexo());
